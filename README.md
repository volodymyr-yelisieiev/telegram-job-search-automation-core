...
[![verify](https://github.com/volodymyr-yelisieiev/telegram-job-search-automation-core/actions/workflows/verify.yml/badge.svg?branch=main)](https://github.com/volodymyr-yelisieiev/telegram-job-search-automation-core/actions/workflows/verify.yml)
[![Node.js >=24](https://img.shields.io/badge/node-%3E%3D24-339933?logo=node.js&logoColor=white)](https://nodejs.org/)
[![pnpm 10.33.0](https://img.shields.io/badge/pnpm-10.33.0-F69220?logo=pnpm&logoColor=white)](https://pnpm.io/)
...
- `docs/prd/Telegram Job Search Automation v1.0.md` - product requirements.
- `docs/security/security-and-privacy.md` - security and privacy posture.
- `docs/runbooks/` - operational runbooks.
- `docs/deployment/` - deployment notes.
- `docs/releases/` - release documentation.
- `docs/examples/` - example evidence and sign-off files.
...
<details>
<summary>Acceptance and live-evidence command sequence</summary>
